...
// ---------------------------------------------------------------------------
// Start team runtime — create state, spawn workers, write initial dispatch requests
// ---------------------------------------------------------------------------
...
interface SpawnWorkerOptions {
   ...
   * env-based model inference inside spawnWorker. Enables per-role model
 ...
 */
async function spawnWorker(opts: SpawnWorkerOptions): Promise<SpawnWorkerResult> {
 ...
 */
export async function startTeam(config: StartTeamConfig): Promise<TeamRuntime> {
...
export async function findActiveTeams(cwd: string): Promise<string[]> {
