import type { TeamConfig, TeamGovernance, TeamManifest, TeamPolicy, TeamTransportPolicy } from './types.js';
...
export declare function normalizeTeamManifest(manifest: TeamManifest): TeamManifest;
 ...
 */
export declare function resolveLifecycleProfile(config?: Pick<TeamConfig, 'lifecycle_profile'> | null, manifest?: Pick<TeamManifest, 'lifecycle_profile'> | null): LifecycleProfile;
/** Returns true when the effective lifecycle profile is 'linked_ralph' */
export declare function isLinkedRalphProfile(config?: Pick<TeamConfig, 'lifecycle_profile'> | null, manifest?: Pick<TeamManifest, 'lifecycle_profile'> | null): boolean;
export {};
